...
CREATE POLICY "service_all_pools" ON pools FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "service_all_members" ON pool_members FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "service_all_requests" ON funding_requests FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "service_all_votes" ON votes FOR ALL USING (auth.role() = 'service_role');
